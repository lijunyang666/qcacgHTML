...
var bookBlockList = Vue.extend({
      ...
      +'<div class="content"><div class="bookBlockList"><div class="bookBlockList_title"><span class="hr"></span><span class="title">轻小说</span><span class="titleTwo">light novel</span></div><ul class="list clear"><li><div class="vertical-img"><a v-link="{path: \'/works\'}"><img src="../img/90x126.png" class="cover"/></a></div><div class="vertical-title"></div></li><li v-for="obj in bookList"><div class="vertical-img"><div class="examine" >审核</div><div class="examine1">审核中</div><div class="examine1">未审核</div> <div class="bookUpdate" >日更</div><div class="bookUpdate1" >月更</div><img :src="path.rootPath + obj.bookCoverImage" class="cover"  v-link="{path: \'/catalogue/\' + obj.bookId}"  /></div><div class="vertical-title" title="{{obj.bookName}}">{{obj.bookName}}</div></li></ul></div></div> '
      +'</div></div></div>'
      ,data: function() {
        return {
        bookList: [],
