...
/***/ function(module, exports, __webpack_require__) {
	...
	var footer = _vueMin2.default.extend({
	  ...
	  + '</div><div class="qcacg-footer-logo" onclick="location.href=\'/qcacg/index.html\'">轻创文学网</div></div><div class="qcacg-bottom"><p>杭州轻悦网络科技有限公司<span class="driver"> |</span>浙ICP备16021285号</p></div></div></footer>'
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bookBlockList = _vueMin2.default.extend({
	  template: '<div class="user_info_right"><div class="user_info_title"><div class="titleBlock">contribute</div><div class="titleBlock_LG">个人投稿</div></div><div class="user_info_content"><div class="contribution">' + '<ul class="nav"><li class="active" v-link="{path: \'/bookBlockList\'}"><span class="circular"></span><span class="title_name">轻小说</span></li><li v-if="showFlag === 999"><span class="circular"></span><span class="title_name">画集</span></li><li v-link="{path: \'/works\'}"><span class="circular"></span><span class="title_name">创建作品</span></li></ul>' + '<div class="content"><div class="bookBlockList"><div class="bookBlockList_title"><span class="hr"></span><span class="title">轻小说</span><span class="titleTwo">light novel</span></div><ul class="list clear"><li><div class="vertical-img"><a v-link="{path: \'/works\'}"><img src="../img/90x126.png" class="cover"/></a></div><div class="vertical-title"></div></li><li v-for="obj in bookList"><div class="vertical-img"><img :src="path.rootPath + obj.bookCoverImage" class="cover"  v-link="{path: \'/catalogue/\' + obj.bookId}"  /></div><div class="vertical-title" title="{{obj.bookName}}">{{obj.bookName}}</div></li></ul></div></div> ' + '</div></div></div>',
	  data: function data() {
	    return {
	      bookList: [],
	      path: _conf2.default
	  ...
	  methods: {
	    ...
	    updateVolumeNameFn: function updateVolumeNameFn() {
	      ...
	      _vueHttp2.default.http(this, 'post', _conf2.default.saveOrUpdateVolume, _data, function (response) {
	        _this4.$set('updateBookChapter', false);
	        _this4.$set('updateBookChapterId', '');
	        _this4.$set('updateBookChapterName', '');
	        _this4.getBookListFn();
	      });
	    },
	    ...
	    getBookListFn: function getBookListFn() {
	      ...
	      _vueHttp2.default.http(this, 'get', _conf2.default.queryBook, _data, function (response) {
	        console.log(response);
	        _this5.$set('volumeCustomList', response.data.bookCustom.volumeCustomList);
	      });
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bookshelf = _vueMin2.default.extend({
	  template: '<div class="user_info_right"><div class="user_info_title"><div class="titleBlock">bookshelf</div><div class="titleBlock_LG">个人书架</div></div><div class="user_info_content"><div class="contribution">' + '<ul class="nav"><li class="active" v-link="{path: \'/bookshelf\'}"><span class="circular"></span><span class="title_name">我的收藏</span></li><li v-link="{path: \'/record\'}"><span class="circular"></span><span class="title_name">浏览记录</span></li></ul>' + '<div class="content"><div class="bookBlockList" ><div class="bookBlockList_title"><span class="hr"></span><span class="title">我的收藏</span><span class="titleTwo">collect</span></div>' + '<div style="min-height:500px;width:100%;">' + '<div v-for="obj in bookList"><div class="book-navAI"><a v-for="temp in obj" :href="path.TemprootPath + \'/view/catalog.html?bookId=\' + temp.bookId"><img title="{{temp.bookName}}" :class="$index === 0?\'book-img\':\'book-img1\'" src="../img/z-imgBj.jpg" @load="szxj.loadImg(temp.bookCoverImage ? path.rootPath + temp.bookCoverImage: \'\', $event)"/></a></div><a v-for="temp in obj" :href="path.TemprootPath + \'/view/catalog.html?bookId=\' + temp.bookId"><span :class="$index === 0?\'book-name\':\'book-name1\'" title="{{ temp.bookName }}">{{ temp.bookName.length > 12? temp.bookName.substring(0, 12).concat(\'...\'):temp.bookName }}</span></a>' + '</div></div></div></div></div>',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var record = _vueMin2.default.extend({
	  template: '<div class="user_info_right"><div class="user_info_title"><div class="titleBlock">bookshelf</div><div class="titleBlock_LG">个人书架</div></div><div class="user_info_content"><div class="contribution">' + '<ul class="nav"><li  v-link="{path: \'/bookshelf\'}"><span class="circular"></span><span class="title_name">我的收藏</span></li><li class="active" v-link="{path: \'/record\'}"><span class="circular"></span><span class="title_name">浏览记录</span></li></ul>' + '<div class="content"><div class="bookBlockList" ><div class="bookBlockList_title"><span class="hr"></span><span class="title">浏览记录</span><span class="titleTwo">browsing history</span></div>' + '<div style="min-height:500px;width:100%;">' + '<div v-for="obj in bookList"><div class="book-navAI"><a v-for="temp in obj" :href="path.TemprootPath + \'/view/catalog.html?bookId=\' + temp.bookId"><img title="{{temp.bookName}}" :class="$index === 0?\'book-img\':\'book-img1\'" src="../img/z-imgBj.jpg" @load="szxj.loadImg(temp.bookCoverImage ? path.rootPath + temp.bookCoverImage: \'\', $event)"/></a></div><a v-for="temp in obj" :href="path.TemprootPath + \'/view/catalog.html?bookId=\' + temp.bookId"><span :class="$index === 0?\'book-name\':\'book-name1\'" title="{{ temp.bookName }}">{{ temp.bookName.length > 12? temp.bookName.substring(0, 12).concat(\'...\'):temp.bookName }}</span></a>' + '</div></div></div></div></div>',
	...
	var message = _vueMin2.default.extend({
	  ...
	  methods: {
	    ...
	    getValueFn: function getValueFn() {
	      ...
	      _vueHttp2.default.http(this, 'get', _conf2.default.findCommentAndReplyByReplyUserId, {}, function (response) {
	        _this2.$set('bookList', response.data);
	        console.log(_this2.bookList);
	      });
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var tellMe = _vueMin2.default.extend({
	  template: '<div class="user_info_right"><div class="user_info_title"><div class="titleBlock">Personal message</div><div class="titleBlock_LG">个人消息</div></div><div class="user_info_content"><div class="contribution">' + '<ul class="nav"><li v-link="{path: \'/message\'}"><div class="mag_number1" :style="bookList.reply === 0 ? \'visibility: ;\':\'display: none;\'" >{{bookList.reply}}</div><span class="circular"></span><span class="title_name">我的回复</span></li><li  v-link="{path: \'/tellMe\'}"><span class="circular"></span><span class="title_name">@我的</span></li><li class="active" v-link="{path: \'/relevant\'}"><div class="mag_number1" :style="bookList.reply === 0 ? \'visibility: ;\':\'display: none;\'">{{bookList.book}}</div><span class="circular"></span><span class="title_name">作品相关</span></li><li  v-link="{path: \'/system\'}"><div class="mag_number1" :style="bookList.reply === 0 ? \'visibility: ;\':\'display: none;\'">{{bookList.system}}</div><span class="circular"></span><span class="title_name">系统消息</span></li><li  v-link="{path: \'/official\'}"><div class="mag_number1" :style="bookList.reply === 0 ? \'visibility: ;\':\'display: none;\'">{{bookList.official}}</div><span class="circular"></span><span class="title_name">官方公共</span></li></ul>' + '<div class="content"><div class="bookBlockList"><div class="bookBlockList_title"><span class="hr"></span><span class="title">@我的</span><span class="titleTwo">work related</span></div><p>此功能暂未开放</p></div>' + '</div></div></div>',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var relevant = _vueMin2.default.extend({
	  template: '<div class="user_info_right"><div class="user_info_title"><div class="titleBlock">Personal message</div><div class="titleBlock_LG">个人消息</div></div><div class="user_info_content"><div class="contribution">' + '<ul class="nav"><li v-link="{path: \'/message\'}"><div class="mag_number1" :style="bookList.reply === 0 ? \'visibility: ;\':\'display: none;\'" >{{bookList.reply}}</div><span class="circular"></span><span class="title_name">我的回复</span></li><li  v-link="{path: \'/tellMe\'}"><span class="circular"></span><span class="title_name">@我的</span></li><li class="active" v-link="{path: \'/relevant\'}"><div class="mag_number1" :style="bookList.reply === 0 ? \'visibility: ;\':\'display: none;\'">{{bookList.book}}</div><span class="circular"></span><span class="title_name">作品相关</span></li><li  v-link="{path: \'/system\'}"><div class="mag_number1" :style="bookList.reply === 0 ? \'visibility: ;\':\'display: none;\'">{{bookList.system}}</div><span class="circular"></span><span class="title_name">系统消息</span></li><li  v-link="{path: \'/official\'}"><div class="mag_number1" :style="bookList.reply === 0 ? \'visibility: ;\':\'display: none;\'">{{bookList.official}}</div><span class="circular"></span><span class="title_name">官方公共</span></li></ul>' + '<div class="content"><div class="bookBlockList" "><div class="bookBlockList_title"><span class="hr"></span><span class="title">作品相关</span><span class="titleTwo">work related</span></div><div v-for="obj in bookList.info" ><div class="img-attention-word"><span class="attention-word1">{{obj.messageTitle}}</span><span class="attention-word2">{{obj.messageCreateDate}}</span></div><p>{{obj.message}}</p><hr style="border: 1px solid #E1E1E1; margin:0 0 0 5%;" width="90%" /></div><div id="page" class="page"><ul><li><a>上一页</a></li><li><a>1</a></li><li class="active"><a>2</a></li><li><a>3</a></li><li><a>4</a></li><li><a>5</a></li><li><a>下一页</a></li><li class="goto"><input type="text" value="" /><span>/1211</span><a>转页</a></li></ul></div>' + '</div></div></div>',
	  ...
	  methods: {
	    ...
	    getValueFn: function getValueFn() {
	      ...
	      _vueHttp2.default.http(this, 'get', _conf2.default.queryMsg, this.queryMsgObj, function (response) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var system = _vueMin2.default.extend({
	  template: '<div class="user_info_right"><div class="user_info_title"><div class="titleBlock">Personal message</div><div class="titleBlock_LG">个人消息</div></div><div class="user_info_content"><div class="contribution">' + '<ul class="nav"><li v-link="{path: \'/message\'}"><div class="mag_number1" :style="bookList.reply === 0 ? \'visibility: ;\':\'display: none;\'" >{{bookList.reply}}</div><span class="circular"></span><span class="title_name">我的回复</span></li><li  v-link="{path: \'/tellMe\'}"><span class="circular"></span><span class="title_name">@我的</span></li><li class="active" v-link="{path: \'/relevant\'}"><div class="mag_number1" :style="bookList.reply === 0 ? \'visibility: ;\':\'display: none;\'">{{bookList.book}}</div><span class="circular"></span><span class="title_name">作品相关</span></li><li  v-link="{path: \'/system\'}"><div class="mag_number1" :style="bookList.reply === 0 ? \'visibility: ;\':\'display: none;\'">{{bookList.system}}</div><span class="circular"></span><span class="title_name">系统消息</span></li><li  v-link="{path: \'/official\'}"><div class="mag_number1" :style="bookList.reply === 0 ? \'visibility: ;\':\'display: none;\'">{{bookList.official}}</div><span class="circular"></span><span class="title_name">官方公共</span></li></ul>' + '<div class="content"><div class="bookBlockList" ><div class="bookBlockList_title"><span class="hr"></span><span class="title">系统消息</span><span class="titleTwo">system</span></div><div v-for="obj in bookList.info"><div class="img-attention-word"><span class="attention-word1">{{obj.messageTitle}}</span><span class="attention-word2">{{obj.messageCreateDate}}</span></div><p>{{obj.message}}</p><hr style="border: 1px solid #E1E1E1; margin:0 0 0 5%;" width="90%" /></div><div id="page" class="page"><ul><li><a>上一页</a></li><li><a>1</a></li><li class="active"><a>2</a></li><li><a>3</a></li><li><a>4</a></li><li><a>5</a></li><li><a>下一页</a></li><li class="goto"><input type="text" value="" /><span>/1211</span><a>转页</a></li></ul></div>' + '</div></div></div>',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var official = _vueMin2.default.extend({
	  template: '<div class="user_info_right"><div class="user_info_title"><div class="titleBlock">Personal message</div><div class="titleBlock_LG">个人消息</div></div><div class="user_info_content"><div class="contribution">' + '<ul class="nav"><li v-link="{path: \'/message\'}"><div class="mag_number1" :style="bookList.reply === 0 ? \'visibility: ;\':\'display: none;\'" >{{bookList.reply}}</div><span class="circular"></span><span class="title_name">我的回复</span></li><li  v-link="{path: \'/tellMe\'}"><span class="circular"></span><span class="title_name">@我的</span></li><li class="active" v-link="{path: \'/relevant\'}"><div class="mag_number1" :style="bookList.reply === 0 ? \'visibility: ;\':\'display: none;\'">{{bookList.book}}</div><span class="circular"></span><span class="title_name">作品相关</span></li><li  v-link="{path: \'/system\'}"><div class="mag_number1" :style="bookList.reply === 0 ? \'visibility: ;\':\'display: none;\'">{{bookList.system}}</div><span class="circular"></span><span class="title_name">系统消息</span></li><li  v-link="{path: \'/official\'}"><div class="mag_number1" :style="bookList.reply === 0 ? \'visibility: ;\':\'display: none;\'">{{bookList.official}}</div><span class="circular"></span><span class="title_name">官方公共</span></li></ul>' + '<div class="content"><div class="bookBlockList" ><div class="bookBlockList_title"><span class="hr"></span><span class="title">官方公共</span><span class="titleTwo">official public</span></div><div v-for="obj in bookList.info"><div class="img-attention-word"><span class="attention-word1">{{obj.messageTitle}}</span><span class="attention-word2">{{obj.messageCreateDate}}</span></div><p>{{obj.message}}</p><hr style="border: 1px solid #E1E1E1; margin:0 0 0 5%;" width="90%" /></div>' + '<div id="page" class="page"><ul><li class="btn" @click="setPage((RequestObj.pageNo - 1) >= 1 ? (RequestObj.pageNo - 1) : 1)"><a>上一页</a></li>          <li v-if="(($index + 1)<= 5 && RequestObj.pageNo< 3 || (($index + 1) > RequestObj.pageNo - 3 &&  $index< RequestObj.pageNo)) || ( (($index + 1)<= RequestObj.pageNo + 2 &&　($index + 1) > RequestObj.pageNo) || (RequestObj.pageNo > obj.pageCount - 3 && ($index + 6) > obj.pageCount) )" :class="objTemp == RequestObj.pageNo? \'active\':\'\'" v-for="objTemp in page" @click="setPage(objTemp)"><a>{{ objTemp }}</a></li><li class="btn" @click="setPage((RequestObj.pageNo + 1)<= obj.pageCount ? (RequestObj.pageNo + 1) : obj.pageCount)"><a>下一页</a></li><li class="goto"><input type="text" v-model="pageNo" style="text-align: center;"/><span>{{ RequestObj.pageNo }}/{{ obj.pageCount }}</span><a class="btn" @click="setPage(pageNo)">转页</a></li></ul></div>' + '</div></div></div>',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bill = _vueMin2.default.extend({
	  template: '<div class="user_info_right"><div class="user_info_title"><div class="titleBlock">Personal Wallet</div><div class="titleBlock_LG">个人账单</div></div><div class="user_info_content"><div class="contribution">' + '<ul class="nav"><li  v-link="{path: \'/wallet\'}"><span class="circular"></span><span class="title_name">我的钱包</span></li><li class="active" v-link="{path: \'/bill\'}"><span class="circular"></span><span class="title_name">我的账单</span></li></ul>' + '<div class="content"><div class="bookBlockList"><div class="bookBlockList_title"><span class="hr"></span><span class="title">支付账单</span><span class="titleTwo">pay treasure bills</span></div><div class="pay-head2">    可用余额</div><div class="pay-b">    提现</div><div class="pay-c">    充值</div><div class="pay-d">    ￥0.00</div><hr style="border: 1px solid #E1E1E1; margin:0 0 0 5%;" width="90%" /><div class="pay-head2">    历史收入</div><div class="pay-number">    ￥0.00</div><div class="pay-check">    查看账单</div><ul class="explain">    提现说明：<li>1.提现申请成功过不可以撤回</li><li>2.提现金额为100的整数倍（单位人民币）</li><li>3.申请成功后，工作人员会在30个工作日内将相应的金额打入指定账户</li></ul></div>' + '</div></div></div>',
