	  ...
	  methods: {
	    ...
	    getBookListFn: function getBookListFn() {
	      ...
	      _vueHttp2.default.http(this, 'get', _conf2.default.totalIncome, {}, function (response) {
	        _this6.totalIncome = response.data;
	      });
	    },
