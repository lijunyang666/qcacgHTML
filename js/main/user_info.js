...
/***/ function(module, exports, __webpack_require__) {
	...
	var bookBlockList = _vueMin2.default.extend({
	  template: '<div class="user_info_right"><div class="user_info_title"><div class="titleBlock">contribute</div><div class="titleBlock_LG">个人投稿</div></div><div class="user_info_content"><div class="contribution">' + '<ul class="nav"><li class="active" v-link="{path: \'/bookBlockList\'}"><span class="circular"></span><span class="title_name">轻小说</span></li><li v-if="showFlag === 999"><span class="circular"></span><span class="title_name">画集</span></li><li v-link="{path: \'/works\'}"><span class="circular"></span><span class="title_name">创建作品</span></li></ul>' + '<div class="content"><div class="bookBlockList"><div class="bookBlockList_title"><span class="hr"></span><span class="title">轻小说</span><span class="titleTwo">light novel</span></div>' + '<div style="min-height:500px">' + '<ul class="list clear" ><li><div class="vertical-img"><a v-link="{path: \'/works\'}"><img src="../img/90x126.png" class="cover"/></a></div><div class="vertical-title"></div></li><li v-for="obj in bookList"><div class="vertical-img" :style=" obj.bookReviewStatus == \'审核中\' ? \' pointer-events: none;\':\'\' " @click="submitFn" ><div class="state_one" v-if=" obj.bookReviewStatus == \'审核中\' ">审核中</div><div class="state_tow">连载中</div><img :src="path.rootPath + obj.bookCoverImage" class="cover"  v-link="{path: \'/catalogue/\' + obj.bookId}"  /></div><div class="vertical-title" :style=" obj.bookReviewStatus == \'审核中\' ? \' pointer-events: none;\':\'\' " title="{{obj.bookName}}">{{obj.bookName}}</div></li></ul></div></div> ' + '</div>' + '</div></div></div>',
	  data: function data() {
	    return {
	      bookList: [],
	      path: _conf2.default
	  ...
	  methods: {
	    ...
	    classListFn: function classListFn() {
	      ...
	      _vueHttp2.default.http(this, 'get', _conf2.default.queryBookType, {}, function (response) {
	        ...
	        _this3.$set('trueClass', _this3.trueClass);
	      });
	      //============================================
	    },
	    clickClassFn: function clickClassFn(v) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var catalogue = _vueMin2.default.extend({
	  ...
	  methods: {
	    ...
	    updateContentFnTow: function updateContentFnTow() {
	      this.$set('updateBookContentChapter', false);
	    },
	    ...
	    signingTowFn: function signingTowFn() {
	      var _data = {};
	      _data.bookId = parseInt(this.id, 10);
	      _vueHttp2.default.http(this, 'get', _conf2.default.userRegainBookSign, _data, function (response) {});
	    },
	    ...
	    updateVolumeNameFn: function updateVolumeNameFn() {
	      ...
	      _vueHttp2.default.http(this, 'get', _conf2.default.saveOrUpdateVolume, _data, function (response) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updatePass = _vueMin2.default.extend({
	  ...
	  + '<div class="numberAItwo2"><span class="name1">新密码：</span><input type="password" v-model="passWord" /><span class="remark1">密码由6-16个字符组成，区分大小写（不能包含空格）</span></div>' + '<div class="numberAItwo3"><span class="name1">确认新密码：</span><input type="password" v-model="passWordConfirm"  /><span class="remark1">密码强度：</span></div>' + '<div class="numberAItwo4"><span class="name1">手机验证：</span><input type="text" v-model="telephoneCode" />' + '<div class="verify" v-if="verifyFlag" @click="showCaptchaObj">发送验证码</div>' + '<div class="verify_no" v-else>{{verifyNumber}}重新发送</div>' + '<div id="popup-captcha"></div>' + '</div><hr style="border: 1px dotted #E1E1E1; margin:0 0 0 5%;" width="90%" /><div class="btn change" @click="submitFn">确认</div></div></div>' + '</div></div></div>',
	  ...
	  methods: {
	    ...
	    getBookListFn: function getBookListFn() {
	      ...
	      _vueHttp2.default.http(this, 'get', _conf2.default.amount, {}, function (response) {
	        _this.exchangeableCashAmount = response.data.amount.unexchangeableCashAmount;
	        _this.totalAmount = response.data.amount.exchangeableCashAmount;
	        _this.freezeCashAmount = response.data.amount.welfareCashAmount;
	      });
	      _vueHttp2.default.http(this, 'get', _conf2.default.getStatus, {}, function (response) {
	        _this.$set('data', response.data.status);
	      });
	      _vueHttp2.default.http(this, 'get', _conf2.default.orderSum, {}, function (response) {
	        _this.totalIncome = response.data.data[0];
	        _this.totalpay = response.data.data[1];
	      });
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bill = _vueMin2.default.extend({
	  template: '<div class="user_info_right"><div class="user_info_title"><div class="titleBlock">Personal Wallet</div><div class="titleBlock_LG">个人账单</div></div><div class="user_info_content"><div class="contribution">' + '<ul class="nav"><li class="active" v-link="{path: \'/bill\'}"><span class="circular"></span><span class="title_name">我的账单</span></li><li  v-link="{path: \'/wallet\'}"><span class="circular"></span><span class="title_name">我的钱包</span></li><li  v-link="{path: \'/goodmen\'}"><span class="circular"></span><span class="title_name">我的好人卡</span></li></ul>' + '<div class="content"><div class="bookBlockList"><div class="bookBlockList_title"><span class="hr"></span><span class="title">支付账单</span><span class="titleTwo">pay treasure bills</span></div><div class="pay-head2">    可提现金额</div><div class="pay-b" @click="registrationFn">提现</div><div class="pay-c" @click="exchangeFn">兑换</div><div class="pay-c" @click="moneyRechargeFn">充值</div>' + '<div v-if="goodmenFlag" class="exchange"><span class="exchange_span">请选择兑换数量:</span><ul class="exchange_ul"><li @click="SubmitgoodFn">×100</li><li @click="SubmitgoodFnTow">×500</li><li @click="SubmitgoodFnThr">×1000</li><li @click="SubmitgoodFnFou">×3000</li><li @click="SubmitgoodFnFix">×5000</li><li @click="SubmitgoodFnSix">×10000</li></ul><div class="exchange_divOne"><span class="exchange_div_span ">*注:每1元钱可购买100张好人卡，当前需使用&nbsp<b>{{ amount/100 }}</b>&nbsp金额</span></div><div class="verification_div verification_div_pay  ">购买数量：&nbsp<span @click="downMoneyFnThr" class="verification_letf">-</span><input type="number" oninput="if(value.length>5)value=value.slice(0,7)" maxlength=7 min="0" v-model="amount" /><span @click="upMoneyFnThr" class="verification_right">+</span></div><div class="exchange_div" style="display:none"><span>使用金额</span><input type="number" readonly="readonly"  maxlength=5 v-model="amount"  />元</div><span class="exchange_spanTow">我的余额：{{totalCashAmount}}</span><div class="exchange_divTow" @click="SubmitgoodmenFn">购买</div><div class="exchange_divTow" @click="SubmitgoodmenFnTow">取消</div></div>' + '<div v-if="moneyRecharge" class="moneyRecharge">  <div class="moneyRecharge_header">账户余额充值</div>  <div class="moneyRecharge_name" >昵称&nbsp:<input type="text" v-model="userName" disabled="true" /></div>   <div class="moneyRecharge_name" >账号&nbsp:<input type="text" v-model="telphone " disabled="true"  /></div>   <div class="moneyRecharge_number" >充值金额&nbsp:<input type="number" oninput="if(value.length>5)value=value.slice(0,5)" min="0" v-model="amountNumber" maxlength=5   />元</div>   <div class="moneyRecharge_pay" > <span class="moneyRecharge_choose">支付方式:</span><input type="radio" checked="checked"/><div class="moneyRecharge_img"></div></div><span class="registration_div_span registration_div_spanTow">*注意：提现完成后不予撤回，实际充值金额为&nbsp<b>{{amountNumber}}</b>&nbsp元。</span>  <div class="moneyRecharge_div moneyRecharge_div_div" @click="rechargeFn" >确认</div>  <div class="moneyRecharge_div moneyRecharge_div_div" @click="SubmitmoneyRechargeFn">取消</div> </div>' + '<div v-show="registration == 1" class="registration"><div class="moneyRecharge_header">提现信息登记</div>  <div class="moneyRecharge_name humanName" >真实姓名&nbsp:<input type="text" v-model="name" /></div>   <div class="moneyRecharge_name payNumber"   >支付宝账号&nbsp:<input type="text" v-model="aliAccount"  /></div>  <div class="moneyRecharge_name payNameTow" >确认支付宝账号&nbsp:<input type="text" v-model="againNumber"  /></div>     <div class="moneyRecharge_name verification" >请输入验证码&nbsp:<input type="text" v-model="inputCode" /><span class="verification_span" @click="showCaptchaObj" v-if="verifyFlag">手机验证</span><div class="verification_spanTow" v-else>{{verifyNumber}}重新发送</div><div id="popup-captcha"></div></div> <span class="registration_div_span">*注意：提现信息提交后将无法直接修改，请仔细检查个人信息，确认填写无误后再提交。</span> <div class="moneyRecharge_div" @click="isTrueOrFalseFn"  >确认</div>  <div class="moneyRecharge_div" @click="SubmitregistrationFn" >取消</div>   </div>' + '<div v-if="WithdrawalsFlag" class="registration registrationTow "><div class="moneyRecharge_header">提现</div> <span class="exchange_spanTow exchange_spanTowTow">可提现金额：&nbsp{{exchangeableCashAmount}}</span>   <div class="verification_div">提取金额：&nbsp<span @click="downMoneyFn" class="verification_letf">-</span><input type="number" readonly="readonly" v-model="doubleamount" /><span @click="upMoneyFn" class="verification_right">+</span></div><span class="exchange_spanTow exchange_spanTowTow amount_span">可提现好人卡数量：&nbsp{{givenPayCardAmount}}</span>   <div class="verification_div verification_divTow">提取好人卡：&nbsp<span @click="downMoneyFnTow" class="verification_letf">-</span><input type="number" min="0"  v-model="cardAmount" /><span @click="upMoneyFnTow" class="verification_right">+</span></div><div class="verification_totel">合计：&nbsp<b>{{cardAmount/150 + doubleamount}}</b>&nbsp元</div><div class="moneyRecharge_div"  @click="WithdrawalsFn"   >确认</div>  <div class="moneyRecharge_div" @click="WithdrawalsFnTow" >取消</div>   </div>' + '<div v-if="isTrueOrFalse" class="isTrueShow"><div  class="isTrueOrFalse"><div class="isTrueOrFalse_div">提示</div><span class="isTrueOrFalse_span">请注意核对账号信息是否正确，一经确认，不予撤回。是否确认？</span> <div class="moneyRecharge_div isTrueOrFalseDiv" @click="registrationisFlase"  >确认</div>  <div class="moneyRecharge_div isTrueOrFalseDiv" @click="SubmitisTrueOrFalseFn" >取消</div> </div></div>' + '<div v-if="isTru" class="isTrueShow"><div class="isTrueOrFalse"><div class="isTrueOrFalse_div">提示</div><span class="isTrueOrFalse_span">充值是否成功</span> <div class="moneyRecharge_div isTrueOrFalseDiv detailFn" @click="detailFn"  >充值成功</div>  <div class="moneyRecharge_div isTrueOrFalseDiv detailFn" @click="SubmitdetailFn" >遇到问题</div> </div></div>' + '<div class="pay-d">￥{{exchangeableCashAmount}}</div><hr style="border: 1px solid #E1E1E1; margin:0 0 0 5%;" width="90%" /><div class="pay-head2">    历史收入</div><div class="pay-number">    ￥{{totalIncome}}</div>  <div class="pay-check"><a :href="path.TemprootPath + \'/view/user_info.html#!/wallet\'">查看账单</a></div> <ul class="explain">    提现说明：<li>1.提现申请成功后不可以撤回</li><li>2.提现金额最低为100元（单位人民币）</li><li>3.申请成功后，工作人员会在7个工作日内将相应的金额打入指定账户</li><li>4.提现好人卡比例为150：1。</li></ul></div>' + '</div></div></div>',
	  ...
	  methods: {
	    ...
	    onkeyupFn: function onkeyupFn(amount) {
	      alert('a');
	    },
	    ...
	    getBookListFn: function getBookListFn() {
	      ...
	      _vueHttp2.default.http(this, 'get', _conf2.default.totalIncome, {}, function (response) {
	        _this6.totalIncome = response.data.data;
	      });
	    },
