	...
	var indexHtml = new _vueMin2.default({
	  ...
	  methods: {
	    ...
	    register: function register(validate) {
	      ...
	      _vueHttp2.default.http(this, 'post', _conf2.default.updatePassword, _data, function (response) {
	      ...
	      captchaObj.onReady(function () {
	        ...
	        captchaObj.onSuccess(function () {
	          ...
	          if (This.verificationFlag) {
	            ...
	            _vueHttp2.default.http(This, 'post', _conf2.default.updatePasswordTelephoneCode, _data, function (data) {
