	...
	var indexHtml = new _vueMin2.default({
	  ...
	  methods: {
	    ...
	    verificationBtn: function verificationBtn() {
	      ...
	      _vueHttp2.default.http(this, 'post', _conf2.default.registerTelephoneCode, formData, function (data) {
	        _this.verificationBtnFlag = false;
	        _this.verificationTimeFn();
	    ...
	    register: function register() {
	      ...
	      //        }
	      _vueHttp2.default.http(this, 'get', _conf2.default.register, _data, function (response) {
	        location.href = _this2.path.TemprootPath + '/view/login.html';
	      });
	    },
	    handlerPopup: function handlerPopup(captchaObj) {
	      ...
	      captchaObj.onReady(function () {
	        ...
	        captchaObj.onSuccess(function () {
	          ...
	          $.ajax({
	            url: _conf2.default.VerifyLoginServlet,
	            // 进行二次验证
	            type: "post",
	            dataType: "json",
	            data: {
