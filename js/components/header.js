var header = Vue.extend({
  template: '<header class="qcacg-header-parent" id="qcacg-header-parent" style="position:relative"><div class="qcacg-header"><a :href="path.TemprootPath + \'/index.html\'"><div class="logo">轻创文学网</div></a>   <ul class="nav-left">   <li :class="active === \'\'?\'active\':\'\'"><a :href="path.TemprootPath + \'/index.html\'">首页</a></li><li :class="active === \'\'?\'active\':\'\'"><a :href="path.TemprootPath + \'/view/class.html\'">分类</a></li><li :class="active === \'\'?\'active\':\'\'"><a :href="path.TemprootPath + \'/view/ranking.html\'">排行榜</a></li><li class="none"><a href="javascript:;">画师</a></li><li class="none"><a href="javascript:;">周边</a></li><li :class="active === \'\'?\'active\':\'\'"><a :href="path.TemprootPath + \'/view/welfare.html\'">福利</a></li></ul><ul class="nav-right">'
