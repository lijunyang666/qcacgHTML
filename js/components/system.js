...
var system = Vue.extend({
      ...
      +'<ul class="nav"><li v-link="{path: \'/message\'}"><div class="mag_number1">1</div><span class="circular"></span><span class="title_name">我的回复</span></li><li  v-link="{path: \'/tellMe\'}"><div class="mag_number1">1</div><span class="circular"></span><span class="title_name">@我的</span></li><li  v-link="{path: \'/relevant\'}"><div class="mag_number1">1</div><span class="circular"></span><span class="title_name">作品相关</span></li><li class="active"  v-link="{path: \'/system\'}"><div class="mag_number1">1</div><span class="circular"></span><span class="title_name">系统消息</span></li><li  v-link="{path: \'/official\'}"><div class="mag_number1">1</div><span class="circular"></span><span class="title_name">官方公共</span></li></ul>'
