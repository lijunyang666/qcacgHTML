...
var message = Vue.extend({
      ...
      +'<div class="img-attention-head"></div><ul class="attention_AI_words"><li class="attention_AI_time" >2016-16-11 16:00 </li><li class="attention_AI_detailed">查看详情</li> </ul><div class="attention_AI_name"><span>邪心魔佛</span>回复了你</div><div class="attention_AI_comment"><span>“六道同坠，共渡轮回”</span></div>   <hr style="border: 1px solid #f9f9f9; margin:0 0 0 5%;  " width="90% " />'
      +'</div>'
