...
var works_update = Vue.extend({
      ...
      +'<div class="works_title"><ul><li class="works_sign"></li><li>修改作品</li><li class="works_sont">create a work</li></ul></div><div class="works_name"><p>书名：<input type="text" maxlength="64" v-model="bookName" /></p><p>画师：<input type="text" v-model="ulName" /></p><p>分类：<span id="area-cat-info" class="text-primary">{{ classList }}</span><span v-on:click="classListFn"  class="span btn" style="padding: 2px 8px 3px 8px;">选择分类</span>'
