...
var info = Vue.extend({
      ...
      +'</div><div class="messageAI"><div class="up clear"><span class="up-name ">{{ userInfoList.userName }}</span><ul><li class="up-word">关注：1000</li><li class="up-word">粉丝：1000</li><li class="up-word">好人卡：1222</li></ul></div><div class="centreAI"><img class="imgAI1" src="../img/新个人信息_09.gif"/><span class="font">注册于{{ szxj.getLocalDate(userInfoList.createDate) }}</span><span>uid:&nbsp;{{ userInfoList.userId }}</span></div><div class="downAI"><span>签名：</span>'
