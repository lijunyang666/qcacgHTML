...
var info = Vue.extend({
      ...
      +'<div class="birthday"><span class="name1">生日：</span><input type="text" placeholder="请选择生日时间" v-model="userInfoList.birthday" index="0" readonly="readonly" style="cursor: pointer;" @click="showDate" />'
